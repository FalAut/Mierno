...
#   https://github.com/Griefed/ServerPackCreator/blob/7.1.6/serverpackcreator-api/src/main/resources/de/griefed/resources/server_files/default_template.sh
#
...
installJava() {
  echo "Java is not found in the specified path, the system default Java will be used."
...
echo "Start script generated by ServerPackCreator 7.1.6."
